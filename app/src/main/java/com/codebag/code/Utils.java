...
import com.codebag.bag.wheel.OnWheelScrollListener;
import com.codebag.bag.wheel.WheelView;
import com.codebag.bag.wheel.adapters.NumericWheelAdapter;
...
public class Utils extends Entry {
    ...
    public void alpha() {
        new Object() {
            ...
            void initAlphWheel(WheelView wheel) {
                NumericWheelAdapter adapter = new NumericWheelAdapter(getActivity(), 0, 9);
                adapter.setTextSize(45);
                wheel.setViewAdapter(adapter);
                wheel.setCurrentItem(0);
