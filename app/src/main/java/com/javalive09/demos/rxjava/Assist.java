...
public class Assist {
     ...
     *
     */
    @Test(name = "timeout 对原始Observable的一个镜像，如果过了一个指定的时长仍没有发射数据，它会发一个错误通知")
    public void timeout() {
     ...
     *
     */
    @Test(name = "timestamp 给Observable发射的数据项附加一个时间戳")
