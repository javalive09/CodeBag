...
public class Operate {
    ...
    public void buffer(CodeActivity codeActivity) {
    ...
    public void flatmap(CodeActivity codeActivity) {
        Disposable disposable = Observable.fromArray("a", "b", "c", "d", "e", "f").
    ...
    public void groupBy(CodeActivity codeActivity) {
    ...
    public void map(CodeActivity codeActivity) {
    ...
    public void scan(CodeActivity codeActivity) {
        Disposable disposable = Observable.fromArray("a", "b", "c", "d", "e", "f")
                .scan((s, s2) -> {
    ...
    public void window(CodeActivity codeActivity) {
        Disposable disposable = Observable.fromArray("a", "b", "c", "d", "e", "f")
                .window(2)
