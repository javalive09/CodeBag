...
public class IntentOpenActivity {
    ...
    public void addAccount() {
        CaseActivity.context().startActivity(new Intent(Settings.ACTION_ADD_ACCOUNT));
    }

    @Play(name = "打开APN")
    public void apn() {
        CaseActivity.context().startActivity(new Intent(Settings.ACTION_APN_SETTINGS));
    }

    @Play(name = "打开应用详情")
    public void applicationDetails() {
        CaseActivity.context().startActivity(new Intent(Settings.ACTION_APPLICATION_DETAILS_SETTINGS));
    }

    @Play
    public void captioning() {
        CaseActivity.context().startActivity(new Intent(Settings.ACTION_CAPTIONING_SETTINGS));
    }

    @Play(name = "打开Home设置")
    public void homeSetting() {
        CaseActivity.context().startActivity(new Intent(Settings.ACTION_HOME_SETTINGS));
    }

    @Play(name = "打开搜索设置")
    public void searchSetting() {
        CaseActivity.context().startActivity(new Intent(Settings.ACTION_SEARCH_SETTINGS));
    }

    @Play(name = "打开字典设置")
    public void directionarySetting() {
        CaseActivity.context().startActivity(new Intent(Settings.ACTION_USER_DICTIONARY_SETTINGS));
    }

    @Play(name = "打开WIFI设置")
    public void wifiSetting() {
        CaseActivity.context().startActivity(new Intent(Settings.ACTION_WIFI_SETTINGS));
    }
    ...
    public void openOtherAppService() {
        ...
        intent.setComponent(componentName);
        CaseActivity.context().startService(intent);
    }
    ...
    public void openMarket() {
        String packageName = CaseActivity.context().getPackageName();
        Uri uri = Uri.parse("market://details?id=" + packageName);
        Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
        try {
            CaseActivity.context().startActivity(goToMarket);
